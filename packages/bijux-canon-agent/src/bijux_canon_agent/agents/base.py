...
for all agents in the bijux_canon_agent system. It enforces async execution, feedback-driven
...
class BaseAgent(Generic[InputT, OutputT], ABC):
    """Abstract base class for all agents in the bijux_canon_agent system.
