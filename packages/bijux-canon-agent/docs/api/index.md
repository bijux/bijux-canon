...
- `./artifacts/bijux-canon-agent/api/inputs/`

and writes logs/results under:

- `./artifacts/bijux-canon-agent/api/`
...
The repository includes an OpenAPI file at `../../apis/bijux-canon-agent/v1/schema.yaml`. Keep the router implementation and schema aligned (avoid “spec drift”).
