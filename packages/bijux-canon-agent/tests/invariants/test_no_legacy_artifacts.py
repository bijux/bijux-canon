...
FORBIDDEN_IMPORT_MODULES = {
    "bijux_canon_agent.pipeline.execution",
    "bijux_canon_agent.pipeline.lifecycle",
    "bijux_canon_agent.pipeline.interrupt",
    "bijux_canon_agent.pipeline.io",
    "bijux_canon_agent.pipeline.telemetry",
    "bijux_canon_agent.pipeline.shard_processing",
    "bijux_canon_agent.pipeline.controller",
    "bijux_canon_agent.pipeline.controller_core",
    "bijux_canon_agent.pipeline.controller_runtime",
    "bijux_canon_agent.pipeline.results",
    "bijux_canon_agent.pipeline.outcome",
    "bijux_canon_agent.pipeline.failure",
    "bijux_canon_agent.pipeline.completeness",
    "bijux_canon_agent.pipeline.trace_validator",
    "bijux_canon_agent.pipeline.trace_rules",
    "bijux_canon_agent.pipeline.phases",
    "bijux_canon_agent.pipeline.types",
    "bijux_canon_agent.pipeline.decision",
    "bijux_canon_agent.pipeline.stop_conditions",
    "bijux_canon_agent.pipeline.convergence",
    "bijux_canon_agent.filereaders",
    "bijux_canon_agent.agents.filereader",
}
