"""Ensure the artifact guard keeps writes inside artifacts/bijux-canon-agent/test/."""
...
def test_artifact_guard_prevents_root_writes(tmp_path: Path) -> None:
    """Writing outside artifacts/bijux-canon-agent/test/ must raise a runtime error."""
