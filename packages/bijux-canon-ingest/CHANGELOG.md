...
- Package metadata now points at the numbered ingest handbook route, and the
  README release-readiness surface now tracks the synchronized `0.3.9`
  publish line.

### Fixed

- Source-checkout version fallback now reports `0.3.9`, keeping release checks
  and published metadata aligned.
