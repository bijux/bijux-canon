...
_LAZY_EXPORTS: dict[str, LazyExport] = {
    ...
    "CorpusDiscoveryLimits": (".canonical_ingest", "CorpusDiscoveryLimits"),
    ...
    "MetadataIntegrityCode": (".source_metadata", "MetadataIntegrityCode"),
    "MetadataIntegrityError": (".source_metadata", "MetadataIntegrityError"),
