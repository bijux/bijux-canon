...
from bijux_canon_ingest.application.indexing import IndexBuildConfig, build_index_from_docs
...
def test_build_index_from_docs_writes_bm25_index(tmp_path: Path) -> None:
    ...
    docs = [RawDoc(doc_id="d1", title="Title", abstract="alpha beta gamma", categories="cs.AI")]
