...
The API is versioned and contract-driven. This page is descriptive; the canonical contract is `../../apis/bijux-llm-vex/v1/schema.yaml`, and the generated JSON is `../../apis/bijux-llm-vex/v1/openapi.v1.json` (derived; do not edit).
...
## How to use
- Consult `../../apis/bijux-llm-vex/v1/schema.yaml` to generate clients or validate requests/responses.
...
## References
- Canonical schema (YAML): `../../apis/bijux-llm-vex/v1/schema.yaml`
- Generated JSON: `../../apis/bijux-llm-vex/v1/openapi.v1.json`
