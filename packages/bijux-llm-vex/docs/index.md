...
- API: [api/index.md](api/index.md) and [`apis/bijux-llm-vex/v1/schema.yaml`](https://github.com/bijux/bijux-llm-nexus/blob/main/apis/bijux-llm-vex/v1/schema.yaml) (canonical contract)
...
5) Consult [api/index.md](api/index.md) and [`apis/bijux-llm-vex/v1/schema.yaml`](https://github.com/bijux/bijux-llm-nexus/blob/main/apis/bijux-llm-vex/v1/schema.yaml) when integrating.
...
- **API (FastAPI)**: versioned under `bijux_vex.api.v1` with frozen OpenAPI (`apis/bijux-llm-vex/v1/openapi.v1.json`), endpoints mirror CLI verbs.
