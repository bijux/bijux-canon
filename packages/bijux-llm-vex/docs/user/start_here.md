...
4) API: [api/index.md](../api/index.md) and the canonical schema [apis/bijux-llm-vex/v1/schema.yaml](https://github.com/bijux/bijux-llm-nexus/blob/main/apis/bijux-llm-vex/v1/schema.yaml).
