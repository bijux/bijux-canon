...
"""Compatibility import surface for the former ``bijux_rar`` package name."""

from __future__ import annotations

import bijux_canon_reason as _impl
...
def __getattr__(name: str) -> object:
    """Proxy unresolved attributes to the canonical reasoning package."""
