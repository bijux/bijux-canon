...
- The HTTP API handler snapshots request text to disk under `./artifacts/bijux-llm-agent/api/inputs/` to preserve auditability.
- Treat `artifacts/bijux-llm-agent/` as sensitive if inputs are sensitive.
