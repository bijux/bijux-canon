...
- `../../apis/bijux-llm-agent/` — root-managed OpenAPI schema and API assets
- `../../makes/bijux-agent/` — Make targets used by CI and developers

Generated artifacts belong under `artifacts/bijux-llm-agent/` (or under the CLI `--out` directory).
