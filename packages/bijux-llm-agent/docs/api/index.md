...
- `./artifacts/bijux-llm-agent/api/inputs/`

and writes logs/results under:

- `./artifacts/bijux-llm-agent/api/`
...
The repository includes an OpenAPI file at `../../apis/bijux-llm-agent/v1/schema.yaml`. Keep the router implementation and schema aligned (avoid “spec drift”).
