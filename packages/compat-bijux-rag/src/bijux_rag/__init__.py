...
"""Compatibility alias module for ``bijux_canon_ingest``."""
...
_ALIAS_PACKAGE = "bijux_rag"
_RUNTIME_PACKAGE = "bijux_canon_ingest"
...
def __getattr__(name: str) -> Any:
    """Forward compatibility lookups to the canonical ingest package."""
    return getattr(_runtime_module, name)


def __dir__() -> list[str]:
    """Expose the canonical ingest attributes in interactive discovery."""
