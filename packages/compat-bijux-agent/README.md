...
`bijux-agent` is a compatibility package that preserves the legacy distribution,
...
distribution name. New work should depend on `bijux-canon-agent` directly.
...
- `bijux_agent` Python module
- `bijux-agent` console command
