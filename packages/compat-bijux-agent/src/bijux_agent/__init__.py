...
"""Compatibility alias module for ``bijux_canon_agent``."""
...
_ALIAS_PACKAGE = "bijux_agent"
_RUNTIME_PACKAGE = "bijux_canon_agent"
...
def __getattr__(name: str) -> Any:
    """Forward compatibility lookups to the canonical agent package."""
    return getattr(_runtime_module, name)


def __dir__() -> list[str]:
    """Expose the canonical agent attributes in interactive discovery."""
