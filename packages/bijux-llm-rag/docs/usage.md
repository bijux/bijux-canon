...
bijux-llm-rag process --input data/arxiv_cs_abstracts_10k.csv --output artifacts/bijux-llm-rag/chunks.msgpack --chunk-size 512

# Build index from chunks (BM25 or vector)
bijux-llm-rag index-build --input artifacts/bijux-llm-rag/chunks.msgpack --output artifacts/bijux-llm-rag/index.msgpack --backend bm25

# Retrieve top-k matches
bijux-llm-rag retrieve --index artifacts/bijux-llm-rag/index.msgpack --query "functional programming in RAG" --top-k 10

# Ask with grounded response (citations from retrieved)
bijux-llm-rag ask --index artifacts/bijux-llm-rag/index.msgpack --query "explain RAG effects" --top-k 5 --format json

# Run eval suite (pinned corpus/queries)
bijux-llm-rag eval --suite tests/eval --index artifacts/bijux-llm-rag/index.msgpack
```
