...
├── ../../scripts/bijux-llm-rag/ # root-managed helper scripts (download_data, openapi_drift)
...
- `../../scripts/bijux-llm-rag/download_data.sh` — data fetcher.
- `../../scripts/bijux-llm-rag/openapi_drift.py` — API schema drift checker.
