...
- Compatibility README and overview guidance now point legacy index users at
  the numbered canonical handbook route for `bijux-canon-index`.
...
- Updated compatibility package README links to readable markdown hyperlink text and aligned migration/navigation targets with canonical index handbook routes.
...
- Compatibility handbook links now resolve canonical index package routes at
  `bijux-canon/bijux-canon-index/` instead of numbered slug paths.
