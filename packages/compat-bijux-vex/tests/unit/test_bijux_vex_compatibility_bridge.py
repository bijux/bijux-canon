...
sys.path.insert(
    0,
    str(Path(__file__).resolve().parents[3] / "bijux-canon-index" / "src"),
)
...
LEGACY_NESTED_MODULE_NAME = "bijux_vex.core.runtime.execution_plan"
CANONICAL_NESTED_MODULE_NAME = "bijux_canon_index.core.runtime.execution_plan"
