...
- Internal file layout inside `artifacts/bijux-llm-rar/` but not the mandatory contract files (`spec.json`, `plan.json`, `trace.jsonl`, `verify.json`, `manifest.json`, provenance snapshots).
