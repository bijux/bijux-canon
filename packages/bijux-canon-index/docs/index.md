# bijux-canon-index — vector execution engine with explicit determinism
...
- Docs home: https://bijux.github.io/bijux-canon-index/
- Concepts: [overview/concepts.md](overview/concepts.md)
- API: [api/index.md](api/index.md) and [`apis/bijux-canon-index/v1/schema.yaml`](https://github.com/bijux/bijux-canon/blob/main/apis/bijux-canon-index/v1/schema.yaml) (canonical contract)
...
5) Consult [api/index.md](api/index.md) and [`apis/bijux-canon-index/v1/schema.yaml`](https://github.com/bijux/bijux-canon/blob/main/apis/bijux-canon-index/v1/schema.yaml) when integrating.
