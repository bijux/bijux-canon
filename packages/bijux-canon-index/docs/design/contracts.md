...
- Modules: `src/bijux_canon_index/core/canon.py`, `src/bijux_canon_index/core/ids.py`, `src/bijux_canon_index/core/types.py`.

## Tx + authz + audit
- All mutations run inside a `Tx`, with explicit authz checks and tamper-evident audit chaining.
- Modules: `src/bijux_canon_index/contracts/tx.py`, `src/bijux_canon_index/contracts/authz.py`, `src/bijux_canon_index/domain/provenance/audit.py`.

## ExecutionArtifact
- Portable description of an execution artifact: fingerprints, metric, scoring version, `ExecutionContract`, and replayability.
- Modules: `src/bijux_canon_index/core/types.py` (`ExecutionArtifact`), `src/bijux_canon_index/core/ids.py`, `src/bijux_canon_index/core/invariants.py`.
...
- Modules: `src/bijux_canon_index/domain/provenance/audit.py`, `src/bijux_canon_index/domain/provenance/lineage.py`, `src/bijux_canon_index/domain/provenance/replay.py`, `tests/conformance/test_execution_contracts.py`.

## Backend isolation
- Backend-specific knobs stay below `src/bijux_canon_index/infra/adapters/`.
