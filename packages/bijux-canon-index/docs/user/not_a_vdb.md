# bijux-canon-index is not a vector DB

bijux-canon-index is an execution engine, not a storage system. It does **not** provide vector DB semantics by default.
...
- If you need multi-tenant storage, use a vector DB and run bijux-canon-index for audited execution only.
