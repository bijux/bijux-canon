...
4) API: [api/index.md](../api/index.md) and the canonical schema [apis/bijux-canon-index/v1/schema.yaml](https://github.com/bijux/bijux-canon/blob/main/apis/bijux-canon-index/v1/schema.yaml).
