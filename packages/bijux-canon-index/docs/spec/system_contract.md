...
- Public API modules (stable): `bijux_canon_index.core.types`, `bijux_canon_index.core.contracts.execution_contract`, `bijux_canon_index.core.runtime.vector_execution`, `bijux_canon_index.contracts.resources`, `bijux_canon_index.application.execution_engine`, `bijux_canon_index.api.v1`. Everything else is internal.
