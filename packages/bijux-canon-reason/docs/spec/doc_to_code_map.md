...
- `trace_format.md` → governs `src/bijux_canon_reason/core/rar_types.py`, `interfaces/serialization/trace_jsonl.py`, `verification/checks.py` (schema fields, event validation). Doc supersedes code comments.
