...
- Package metadata now points at the numbered reasoning handbook route, and
  the README release-readiness surface now tracks the synchronized `0.3.9`
  publish line.
...
- Package README badge links now follow the shared badge catalog and point to
  the exact GHCR package pages used for published reasoning bundles.
