...
def test_readme_surfaces_only_use_generated_badges() -> None:
    targets = [
        Path("README.md"),
        Path("docs/index.md"),
        Path("packages/06-bijux-canon-runtime/README.md"),
        Path("packages/05-bijux-canon-agent/README.md"),
        Path("packages/02-bijux-canon-ingest/README.md"),
        Path("packages/04-bijux-canon-reason/README.md"),
        Path("packages/03-bijux-canon-index/README.md"),
