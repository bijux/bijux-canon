...
@pytest.mark.parametrize(
    ...
    [
        (
            "packages/bijux-canon-runtime/CHANGELOG.md",
            "## [0.1.0]",
        ...
        (
            "packages/bijux-canon-agent/CHANGELOG.md",
            "## v0.1.0",
            "bijux-agent/v0.1.0",
            "CHANGELOG.md",
            "## v0.1.0",
        ...
        (
            "packages/bijux-canon-ingest/CHANGELOG.md",
            "## [0.1.0]",
            "bijux-rag/v0.1.0",
            "CHANGELOG.md",
            "## [0.1.0]",
        ...
        (
            "packages/bijux-canon-reason/CHANGELOG.md",
            "## v0.1.0",
            "bijux-rar/v0.1.0",
            "CHANGELOG.md",
            "## v0.1.0",
        ...
        (
            "packages/bijux-canon-index/CHANGELOG.md",
            "## 0.1.0",
            "bijux-vex/v0.1.0",
            "CHANGELOG.md",
            "## v0.1.0",
