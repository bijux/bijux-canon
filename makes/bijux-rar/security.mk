...
BANDIT_THREADS           ?= 0
PACKAGE_SCRIPTS_DIR      ?= $(MONOREPO_ROOT)/scripts/bijux-rar
...
security-audit:  ## Run pip-audit (JSON once) and gate via scripts/bijux-rar/helper_pip_audit.py; prints concise summary
