...
- `Release Support` makes maintainer-only behavior explicit enough that it does not surprise contributors
...
- `Release Support` starts reading like product documentation instead of maintainer guidance
