...
- `Operating Guidelines` makes maintainer-only behavior explicit enough that it does not surprise contributors
...
- `Operating Guidelines` starts reading like product documentation instead of maintainer guidance
