...
bijux-canon-runtime operations pages describe how to install, run, observe, release, and safely operate the package.
...
- define what the operations section covers for bijux-canon-runtime
