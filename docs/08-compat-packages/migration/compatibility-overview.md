...
This page shows whether a preserved legacy name still
...
- when new work should open the canonical packages instead
...
- open `https://bijux.io/bijux-canon/08-compat-packages/migration/validation-strategy/`
