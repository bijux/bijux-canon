...
```mermaid
flowchart LR
    context["bijux-canon-reason / Interfaces"]
    ...
    subgraph pressure["Start Here When You Need To Know"]
        direction TB
        q1["which public or operator-facing surfaces bijux-canon-reason is really asking readers to trust"]
...
```mermaid
flowchart TB
    promise["Compatibility Commitments<br/>clarifies: identify contracts | see caller impact | review compatibility"]
    ...
    focus1 --> focus1_2
    focus1_3["schema files in apis/bijux-canon-reason/v1"]
    focus1 --> focus1_3
    class focus1 ground;
    ...
    focus2 --> focus2_1
    focus2_2["apis/bijux-canon-reason/v1/pinned_openapi.json"]
    focus2 --> focus2_2
    focus2_3["reasoning traces and replay diffs"]
    focus2 --> focus2_3
    class focus2 ground;
