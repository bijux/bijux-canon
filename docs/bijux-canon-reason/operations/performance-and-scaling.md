...
```mermaid
flowchart LR
    context["bijux-canon-reason / Operations"]
    ...
    subgraph pressure["Start Here When You Need To Know"]
        direction TB
        q1["how bijux-canon-reason is installed, run, diagnosed, and released in practice"]
...
```mermaid
flowchart TB
    promise["Performance and Scaling<br/>clarifies: repeat workflows | find diagnostics | release safely"]
    ...
    focus1 --> focus1_2
    focus1_3["HTTP app in src/bijux_canon_reason/api/v1"]
    focus1 --> focus1_3
    class focus1 ground;
    ...
    focus2 --> focus2_1
    focus2_2["tests/e2e for API, CLI, replay gates, retrieval reasoning, and smoke coverage"]
    focus2 --> focus2_2
    focus2_3["tests/perf for retrieval benchmark coverage"]
    focus2 --> focus2_3
    class focus2 ground;
