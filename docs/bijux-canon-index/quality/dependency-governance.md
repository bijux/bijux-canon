...
- `Dependency Governance` says the package is protected but cannot show which proof closes which risk
...
- does `Dependency Governance` show enough proof to trust `bijux-canon-index` after change
