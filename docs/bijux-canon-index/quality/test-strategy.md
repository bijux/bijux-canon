...
- `Test Strategy` says the package is protected but cannot show which proof closes which risk
...
- does `Test Strategy` show enough proof to trust `bijux-canon-index` after change
