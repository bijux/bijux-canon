...
- `Local Development` leaves a maintainer able to repeat the relevant package workflow from checked-in assets
...
- `Local Development` only works if the maintainer already knows unstated steps
...
- does `Local Development` leave a maintainer able to repeat the workflow from checked-in assets
