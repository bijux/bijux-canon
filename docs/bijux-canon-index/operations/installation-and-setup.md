...
- `Installation and Setup` leaves a maintainer able to repeat the relevant package workflow from checked-in assets
...
- `Installation and Setup` only works if the maintainer already knows unstated steps
...
- does `Installation and Setup` leave a maintainer able to repeat the workflow from checked-in assets
