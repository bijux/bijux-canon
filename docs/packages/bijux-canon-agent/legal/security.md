...
- The HTTP API handler snapshots request text to disk under `./artifacts/bijux-canon-agent/api/inputs/` to preserve auditability.
- Treat `artifacts/bijux-canon-agent/` as sensitive if inputs are sensitive.
