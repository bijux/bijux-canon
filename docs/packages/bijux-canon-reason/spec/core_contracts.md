...
4. All artifacts SHALL live under `artifacts/bijux-canon-reason/runs/<run_id>/`; writes elsewhere are forbidden.
...
- Artifacts must live under `artifacts/bijux-canon-reason/runs/<run_id>/`.
...
- Allowing writes outside artifacts/bijux-canon-reason/ → rejected because provenance and determinism would be unenforceable.
