...
The API is versioned and contract-driven. This page is descriptive; the canonical contract is `../../apis/bijux-canon-index/v1/schema.yaml`, and the generated JSON is `../../apis/bijux-canon-index/v1/openapi.v1.json` (derived; do not edit).
...
## How to use
- Consult `../../apis/bijux-canon-index/v1/schema.yaml` to generate clients or validate requests/responses.
...
## References
- Canonical schema (YAML): `../../apis/bijux-canon-index/v1/schema.yaml`
- Generated JSON: `../../apis/bijux-canon-index/v1/openapi.v1.json`
