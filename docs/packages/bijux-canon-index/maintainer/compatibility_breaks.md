...
- Removing or renaming public API modules: `bijux_canon_index.core.types`, `bijux_canon_index.core.contracts.execution_contract`, `bijux_canon_index.core.runtime.vector_execution`, `bijux_canon_index.contracts.resources`, `bijux_canon_index.application.engine`, `bijux_canon_index.api.v1`.
