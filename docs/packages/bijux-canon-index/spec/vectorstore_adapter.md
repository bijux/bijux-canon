...
## Interface
Location: `src/bijux_canon_index/infra/adapters/vectorstore.py`
...
- Adapter implementations live under `src/bijux_canon_index/infra/adapters/`.
- Registry: `src/bijux_canon_index/infra/adapters/vectorstore_registry.py` resolves adapters by name.
