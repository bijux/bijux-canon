...
- Treating bijux-canon-index as a vector DB: there is no CRUD, indexing API, or serving tier; executions are contract-bound.
...
Use bijux-canon-index when you need audited execution comparisons, not managed vector storage.
