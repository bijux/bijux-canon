...
flowchart LR
    ...
    unit["Fast proof<br/>tests/unit for local behavior"]
    endtoend["Boundary proof<br/>tests/integration and tests/e2e for end-to-end"]
    deeper["Long-lived proof<br/>tests/api for HTTP-facing validation"]
