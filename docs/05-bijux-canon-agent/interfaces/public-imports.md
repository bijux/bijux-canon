...
flowchart LR
    ...
    root["Import root<br/>bijux_canon_agent"]
    boundary["Source boundary<br/>packages/bijux-canon-agent/src/bijux_canon_agent"]
    proof["Compatibility proof<br/>tests/invariants for package promises that"]
