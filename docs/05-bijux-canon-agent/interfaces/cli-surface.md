...
The CLI surface for `bijux-canon-agent` is the command boundary operators and scripts will treat as stable first. If the command semantics for orchestration behavior are real, the docs should say so plainly.

## What To Check

- name the canonical command entrypoint: `bijux-canon-agent`
