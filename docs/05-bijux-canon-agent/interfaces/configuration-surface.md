...
Configuration is part of the contract when it changes how `bijux-canon-agent` exposes orchestration behavior. Operators should be able to tell what may vary without reading code.
