...
Performance work on `bijux-canon-agent` should preserve the behaviors the package already promises. Faster execution is not an improvement if it makes workflow and trace behavior harder to trust or harder to reproduce.
