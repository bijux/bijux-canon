...
Local development for `bijux-canon-agent` should keep code, docs, and proof close enough together that changes to workflow and trace behavior stay easy to explain before they spread outward.
