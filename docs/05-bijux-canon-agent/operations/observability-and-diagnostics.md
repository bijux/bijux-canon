...
Diagnostics make it easier to explain what `bijux-canon-agent` did, not merely that it ran.
...
flowchart LR
    ...
    artifacts["Inspect outputs<br/>trace-backed final outputs<br/>workflow graph execution records"]
    modules["Trace back through<br/>CLI entrypoint in src/bijux_canon_agent/interfaces/cli/entrypoint.py<br/>tests/unit for local behavior"]
