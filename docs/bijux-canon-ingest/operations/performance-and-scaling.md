...
flowchart TB
    ...
    step3 --> page
    run1["tests/unit for module-level behavior across processing, retrieval, and interfaces"]
    page --> run1
    run2["tests/e2e for package boundary coverage"]
    page --> run2
    run3["tests/invariants for long-lived repository promises"]
    page --> run3
