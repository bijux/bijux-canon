...
Use the quality section to understand how `bijux-canon-ingest` earns trust: which tests matter most, which risks remain visible, and what done should mean after a real change.

These pages explain the proof story for `bijux-canon-ingest`. They should make it clear why the package is trustworthy today, what still needs explicit skepticism, and which review questions protect against shallow acceptance disguised as progress.
...
- define what the quality section covers for bijux-canon-ingest
...
- does `Quality` show enough proof to trust `bijux-canon-ingest` after change
