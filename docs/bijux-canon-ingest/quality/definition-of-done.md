...
flowchart LR
    ...
    proof1["tests/e2e for package boundary coverage"]
    proof1 --> page
    proof2["tests/invariants for long-lived repository promises"]
    proof2 --> page
    proof3["tests/unit for module-level behavior across processing, retrieval, and interfaces"]
    proof3 --> page
