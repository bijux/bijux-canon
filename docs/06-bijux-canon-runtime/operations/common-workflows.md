...
Common workflows should show the recurring paths maintainers actually follow when changing or re-running `bijux-canon-runtime`. If a recurring path is still reconstructed from memory, the runbook is incomplete.
