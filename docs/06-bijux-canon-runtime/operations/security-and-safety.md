...
Security and safety review for `bijux-canon-runtime` should start from the real authority the package holds over governed run behavior. Generic caution language is weaker than a clear statement of what the package can actually affect.
