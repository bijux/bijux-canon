...
Performance work on `bijux-canon-runtime` should preserve the behaviors the package already promises. Faster execution is not an improvement if it makes governed run behavior harder to trust or harder to reproduce.
