...
Installation and setup for `bijux-canon-runtime` should tell a maintainer which checked-in files define a valid starting point. If setup for governed run behavior depends on local folklore, the package is not operationally ready.
