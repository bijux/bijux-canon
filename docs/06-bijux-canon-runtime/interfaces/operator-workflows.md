...
flowchart LR
    ...
    entry["Entrypoint<br/>bijux-canon-runtime<br/>HTTP app in src/bijux_canon_runtime/api/v1"]
    output["Reviewable output<br/>execution store records"]
    validate["Validate with<br/>tests/e2e for governed flow behavior"]
