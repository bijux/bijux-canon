...
flowchart LR
    client["HTTP client"]
    schema["Tracked contract<br/>apis/bijux-canon-runtime/v1/schema.yaml<br/>apis/bijux-canon-runtime/v1/pinned_openapi.json"]
    modules["Owning modules<br/>HTTP app in src/bijux_canon_runtime/api/v1"]
    outputs["Caller-visible shape<br/>execution store records"]
