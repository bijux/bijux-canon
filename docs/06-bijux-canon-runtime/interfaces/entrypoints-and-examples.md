...
flowchart LR
    ...
    entry["Entrypoint<br/>CLI entrypoint in src/bijux_canon_runtime/interfaces/cli/entrypoint.py"]
    examples["Examples and fixtures<br/>examples/ for minimal flows, replay<br/>apis/bijux-canon-runtime/v1/schema.hash for schema integrity checks"]
    proof["Executable proof<br/>tests/e2e for governed flow behavior"]
