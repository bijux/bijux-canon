...
flowchart LR
    ...
    root["Import root<br/>bijux_canon_runtime"]
    boundary["Source boundary<br/>packages/bijux-canon-runtime/src/bijux_canon_runtime"]
    proof["Compatibility proof<br/>tests/regression and tests/smoke for replay"]
