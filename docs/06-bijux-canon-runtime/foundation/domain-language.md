...
```mermaid
flowchart LR
    name["Package name<br/>bijux-canon-runtime"]
    importroot["Import root<br/>bijux_canon_runtime"]
    cli["Reader entrypoint<br/>bijux-canon-runtime"]
    artifact["Output nouns<br/>execution store records<br/>replay decision artifacts"]
    name --> importroot
    importroot --> cli
    importroot --> artifact
