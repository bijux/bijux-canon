...
flowchart LR
    client["HTTP client"]
    schema["Tracked contract<br/>apis/bijux-canon-index/v1/schema.yaml<br/>apis/bijux-canon-index/v1/pinned_openapi.json"]
    modules["Owning modules<br/>HTTP app under src/bijux_canon_index/api"]
    outputs["Caller-visible shape<br/>vector execution result collections"]
