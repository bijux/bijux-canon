...
flowchart LR
    ...
    review2["tests/unit for API, application, contracts, domain, infra, and tooling"]
    review2 -.raises compatibility pressure on.-> page
    review3["tests/e2e for CLI workflows, API smoke, determinism gates, and provenance gates"]
...
- package source root: `packages/03-bijux-canon-index/src/bijux_canon_index`
