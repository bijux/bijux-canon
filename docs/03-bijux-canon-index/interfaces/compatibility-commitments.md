...
flowchart LR
    ...
    contract["Check docs and schema<br/>apis/bijux-canon-index/v1/schema.yaml"]
    proof["Run owning proof<br/>tests/conformance and tests/compat_v01 for compatibility"]
