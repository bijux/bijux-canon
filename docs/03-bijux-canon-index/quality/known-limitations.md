...
Known limitations keep `bijux-canon-index` credible by naming what it does not promise. Trust improves when limits are explicit enough that readers do not have to discover them the hard way.

## What To Check

- name the limits that still affect retrieval and replay behavior
