...
The test strategy for `bijux-canon-index` should show how executable evidence is supposed to defend retrieval and replay behavior. A pile of checks is not yet a strategy unless it says what each layer proves.
