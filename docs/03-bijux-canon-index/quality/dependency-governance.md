...
Dependency governance for `bijux-canon-index` matters because new libraries can reshape authority, setup, and risk around retrieval and replay behavior. Dependency review should stay technical rather than ceremonial.
