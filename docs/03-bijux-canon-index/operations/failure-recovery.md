...
Failure recovery for `bijux-canon-index` starts by stabilizing evidence around retrieval and replay behavior before attempting a fix. Recovery should narrow the problem quickly instead of encouraging random retries.

## What To Check

- start with the artifacts and outputs that expose failure: retrieval payloads, replay-visible records, and index diagnostics
