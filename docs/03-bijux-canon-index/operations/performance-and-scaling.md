...
Performance work on `bijux-canon-index` should preserve the behaviors the package already promises. Faster execution is not an improvement if it makes retrieval and replay behavior harder to trust or harder to reproduce.
