...
Release and versioning for `bijux-canon-index` should explain how changes to retrieval and replay behavior become visible to readers and callers. Version numbers are only credible when the release story names what changed and why.
