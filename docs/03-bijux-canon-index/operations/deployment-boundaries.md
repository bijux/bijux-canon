...
```mermaid
flowchart LR
    package["Package unit<br/>packages/bijux-canon-index"]
    metadata["Declared surface<br/>packages/bijux-canon-index/pyproject.toml"]
    boundary["Entrypoints and artifacts<br/>CLI modules under src/bijux_canon_index/interfaces/cli<br/>vector execution result collections"]
