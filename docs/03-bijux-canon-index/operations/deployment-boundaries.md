...
flowchart LR
    ...
    step1["CLI modules under src/bijux_canon_index/interfaces/cli"]
    step1 --> page
    ...
    page --> run1
    run2["tests/unit for API, application, contracts, domain, infra, and tooling"]
    page --> run2
    run3["tests/e2e for CLI workflows, API smoke, determinism gates, and provenance gates"]
    page --> run3
