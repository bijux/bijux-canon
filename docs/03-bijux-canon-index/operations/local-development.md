...
Local development for `bijux-canon-index` should keep code, docs, and proof close enough together that changes to retrieval and replay behavior stay easy to explain before they spread outward.
