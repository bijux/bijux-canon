...
Use the architecture section to understand how `bijux_canon_agent` is put together before you judge a refactor, a dependency change, or a new seam.

These pages turn `bijux-canon-agent` from a directory tree into a readable design. They should help a reviewer trace responsibilities, execution paths, and pressure points quickly enough to keep structural conversations grounded.
