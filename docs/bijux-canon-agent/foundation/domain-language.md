...
- `Domain Language` leaves a reviewer able to explain `bijux-canon-agent` in one clean sentence without hand-waving
...
- `Domain Language` needs repeated exceptions before the package role makes sense
