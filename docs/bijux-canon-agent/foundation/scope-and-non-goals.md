...
- `Scope and Non-Goals` leaves a reviewer able to explain `bijux-canon-agent` in one clean sentence without hand-waving
...
- does `Scope and Non-Goals` still let a reviewer state `bijux-canon-agent` ownership in one clear sentence
