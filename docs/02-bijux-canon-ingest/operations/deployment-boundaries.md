...
Deployment boundaries for `bijux-canon-ingest` should protect the idea that the package is publishable and operable as its own unit. Deployment assumptions that quietly require the whole repository weaken that claim.
