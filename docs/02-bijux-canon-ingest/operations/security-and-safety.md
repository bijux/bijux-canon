...
Security and safety review for `bijux-canon-ingest` should start from the real authority the package holds over prepared ingest behavior. Generic caution language is weaker than a clear statement of what the package can actually affect.
