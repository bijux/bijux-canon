...
Installation and setup for `bijux-canon-ingest` should tell a maintainer which checked-in files define a valid starting point. If setup for prepared ingest behavior depends on local folklore, the package is not operationally ready.
