...
flowchart LR
    ...
    metadata["Read package metadata<br/>packages/bijux-canon-ingest/pyproject.toml"]
    install["Install or invoke<br/>bijux-canon-ingest"]
    smoke["Smoke-check with<br/>tests/e2e for package boundary coverage"]
