...
flowchart LR
    ...
    boundary["Start here<br/>infra"]
    owner["Then inspect<br/>retrieval"]
    core["Confirm rules in<br/>processing"]
    tests["Finish in tests<br/>tests/unit for module-level behavior across"]
