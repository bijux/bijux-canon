...
flowchart LR
    ...
    root["Import root<br/>bijux_canon_ingest"]
    boundary["Source boundary<br/>packages/bijux-canon-ingest/src/bijux_canon_ingest"]
    proof["Compatibility proof<br/>tests/invariants for long-lived repository promises"]
