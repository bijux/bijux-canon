...
flowchart LR
    ...
    boundary["Boundary loader<br/>configuration modules under src/bijux_canon_ingest/config"]
    behavior["Runtime behavior"]
    review["Review with<br/>tests/unit for module-level behavior across"]
