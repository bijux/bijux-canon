...
Release and versioning for `bijux-canon-reason` should explain how changes to reasoning outputs and verification behavior become visible to readers and callers. Version numbers are only credible when the release story names what changed and why.
