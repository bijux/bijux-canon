...
flowchart LR
    ...
    entry["Check entry surface<br/>CLI app in src/bijux_canon_reason/interfaces/cli"]
    evidence["Inspect evidence<br/>reasoning traces and replay diffs"]
    rerun["Reproduce with proof<br/>tests/e2e for API, CLI, replay"]
