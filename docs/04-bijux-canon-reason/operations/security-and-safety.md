...
Security and safety review for `bijux-canon-reason` should start from the real authority the package holds over reasoning outputs and verification behavior. Generic caution language is weaker than a clear statement of what the package can actually affect.
