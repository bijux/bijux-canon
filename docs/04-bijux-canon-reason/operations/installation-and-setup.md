...
flowchart LR
    ...
    metadata["Read package metadata<br/>packages/bijux-canon-reason/pyproject.toml"]
    install["Install or invoke<br/>bijux-canon-reason"]
    smoke["Smoke-check with<br/>tests/e2e for API, CLI, replay"]
