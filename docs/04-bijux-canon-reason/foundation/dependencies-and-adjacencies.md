...
flowchart LR
    ...
    package["bijux-canon-reason<br/>package boundary"]
    adj1["Upstream or downstream<br/>uses ingest evidence and index retrieval"]
    adj2["Governance seam<br/>runtime owns accepted replay and storage"]
    deps --> package
    package --> adj1
    package --> adj2
