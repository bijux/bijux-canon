...
flowchart LR
    ...
    package["bijux-canon-reason<br/>integration boundary"]
    schemas["Schemas and artifacts<br/>apis/bijux-canon-reason/v1/schema.yaml<br/>reasoning traces and replay"]
