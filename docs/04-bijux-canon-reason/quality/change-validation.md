...
Change validation for `bijux-canon-reason` should match the seam that actually moved. Strong validation means choosing evidence that tests the real risk around reasoning and verification behavior, not just adding more checks mechanically.
