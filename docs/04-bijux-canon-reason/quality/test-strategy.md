...
flowchart LR
    ...
    unit["Fast proof<br/>tests/unit for planning, reasoning, execution"]
    endtoend["Boundary proof<br/>tests/e2e for API, CLI, replay"]
    deeper["Long-lived proof<br/>tests/docs for documentation-linked safeguards"]
