...
def main() -> int:
    ...
    parser.add_argument(
        "--expected", type=Path, default=Path("artifacts/bijux-canon-index/api/expected.json")
    )
    parser.add_argument(
        "--actual", type=Path, default=Path("artifacts/bijux-canon-index/api/current.json")
    )
