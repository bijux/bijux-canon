...
verify-test-install:
	...
	$$tmp/venv/bin/pip install -i https://test.pypi.org/simple --extra-index-url https://pypi.org/simple bijux-agent==$(PKG_VERSION); \
	$$tmp/venv/bin/python -m bijux_agent.main --help >/dev/null 2>&1; \
